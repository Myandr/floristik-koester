...
export async function POST(req: NextRequest) {
  ...
  await transporter.sendMail({
    ...
    subject: `[Hochzeitsfloristik] Beratungsanfrage von ${fullName}`,
    text: `Hochzeitsfloristik – Beratungsanfrage\n\nAnrede: ${anrede || "–"}\nName: ${fullName}\nE-Mail: ${email}\nTelefon: ${telefon}\nWunschtermin: ${wunschtermin}\nUhrzeit: ${uhrzeit || "–"}\n\nNachricht:\n${nachricht || "–"}`,
    html: `
      <div style="font-family:Georgia,serif;max-width:600px;margin:0 auto;padding:32px;">
        <h2 style="color:#1B2B7A;margin-bottom:4px;">Hochzeitsfloristik – Beratungsanfrage</h2>
